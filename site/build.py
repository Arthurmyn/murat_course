...
steps = [
    {"num": "1", "title": "Обучение", "text": "Изучаем теорию и инструменты."},
    {"num": "2", "title": "Практика", "text": "Работаем на реальных ресторанных задачах."},
    {"num": "3", "title": "Разбор ошибок", "text": "Показываем, где возникают потери и ошибки в учёте."},
    {"num": "4", "title": "Самостоятельная работа", "text": "Ученик выполняет практические задания."},
    {"num": "5", "title": "Результат", "text": "Человек понимает, как самостоятельно работать калькулятором."},
]
...
skills_html = "\n".join(
    f'<span style="background:#fff;border:1px solid #e0dede;border-radius:24px;padding:14px 22px;font:500 15.5px/1 \'Onest\',sans-serif;color:#14171c">{e(s)}</span>'
    for s in skills
)
...
steps_html = "\n".join(f'''<div style="display:flex;flex-direction:column;gap:14px">
  <div style="width:40px;height:40px;background:#14171c;border-radius:50%;display:flex;align-items:center;justify-content:center">
    <span style="font:800 16px/1 'Onest',sans-serif;color:#fff">{e(s["num"])}</span>
  </div>
  <h3 style="font:800 17px/1.25 'Onest',sans-serif;letter-spacing:-.005em;color:#14171c;margin:0">{e(s["title"])}</h3>
  <p style="font:500 14px/1.5 'Onest',sans-serif;margin:0;color:#4a4a4a">{e(s["text"])}</p>
</div>''' for s in steps)
...
<section style="position:relative;background:{ACCENT};overflow:hidden">
  ...
  <div class="grid-hero" style="max-width:1240px;margin:0 auto;padding:56px 40px 96px;position:relative;display:grid;grid-template-columns:minmax(0,1fr) 460px;gap:64px;align-items:center">
    <div>
      ...
      <h1 style="font:800 50px/1.12 'Onest',sans-serif;letter-spacing:-.01em;text-transform:uppercase;color:#fff;margin:0 0 26px;max-width:16ch">Бухгалтер-калькулятор с нуля до уверенной работы в ресторане</h1>
    ...
    <div>
      <div style="border:2px solid rgba(255,255,255,.5);border-radius:22px;padding:14px">
        <div style="position:relative;border-radius:14px;overflow:hidden;aspect-ratio:4/5">
          <img src="images/murat.webp" alt="Мурат Ибрагимов" style="width:100%;height:100%;object-fit:cover;object-position:50% 8%;display:block" />
          <div style="position:absolute;inset:0;background:linear-gradient(0deg,rgba(0,0,0,.4) 0%,transparent 35%)"></div>
        </div>
      </div>
    </div>
  </div>
...
<section style="position:relative;overflow:hidden;border-bottom:1px solid #e9eaed">
  ...
  <div style="max-width:1240px;margin:0 auto;padding:88px 40px;position:relative">
    <h2 style="font:800 42px/1.12 'Onest',sans-serif;letter-spacing:-.01em;margin:0 0 48px">
...
<section style="position:relative;overflow:hidden;border-bottom:1px solid #e9eaed;background:#f5f5f5">
  ...
  <div style="max-width:1240px;margin:0 auto;padding:88px 40px;position:relative">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:12px;max-width:1000px;margin:0 0 36px">
      {skills_html}
    </div>
...
<section id="program" style="position:relative;overflow:hidden;border-bottom:1px solid #e9eaed">
  ...
  <div style="max-width:1240px;margin:0 auto;padding:96px 40px;position:relative">
    <div style="display:flex;align-items:center;gap:18px;margin:0 0 24px">
      <h2 style="font:800 42px/1.12 'Onest',sans-serif;letter-spacing:-.01em;color:#14171c;margin:0">Программа<br>курса</h2>
      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" style="flex:none;margin-top:8px"><circle cx="12" cy="12" r="11" stroke="{ACCENT}" stroke-width="1.4"/><path d="M9 8l4 4-4 4" stroke="{ACCENT}" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </div>
...
<section style="position:relative;overflow:hidden;border-bottom:1px solid #e9eaed;background:#f5f5f5">
  ...
  <div style="max-width:1240px;margin:0 auto;padding:88px 40px;position:relative">
    <h2 style="font:800 42px/1.12 'Onest',sans-serif;letter-spacing:-.01em;margin:0 0 48px">
      <span style="color:#14171c">Как проходит</span><br><span style="color:{ACCENT}">обучение</span>
    </h2>
    <div class="grid-steps" style="display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:20px">
      {steps_html}
    </div>
  </div>
</section>
